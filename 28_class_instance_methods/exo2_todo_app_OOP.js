/*
In this project, you will write the class that powers a Todo app.
...
class Todos {
    ...
    getWork(){
        return this.todos.filter((someTd)=>{
            return someTd.category==="work"
        });
    }
    getWorkCount(){
    ...
    getPersonal(){
        return this.todos.filter((someTd)=>{
            return someTd.category==="personal"
        });
    }
    getPersonalCount(){
